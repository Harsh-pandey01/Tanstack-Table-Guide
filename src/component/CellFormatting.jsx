...
import { CellFormattingColumnsDef } from "./columns/CellFormattingColumnsDef";
function CellFormatting() {
  // creating a table instace
  const tableInstance = useReactTable({
    data: data, // providing the table data
    columns: CellFormattingColumnsDef, // defining the table columns to bind with the data
