...
import { mergedCellsColumnDef } from "./columns/MergeCellsColumns";
function MergedCellTable() {
  // creating a table instace
  const tableInstance = useReactTable({
    data: data, // providing the table data
    columns: mergedCellsColumnDef, // defining the table columns to bind with the data
